...
import type { ElementToValue, FormElement } from '@/schema/options/types'
 ...
 *
 * The model is backed by the {@link useOptionsFormDataStore}.
 *
...
function useModel<T extends FormElement>(
    ...
    const { getValue, setValue } = useOptionsFormDataStore()
